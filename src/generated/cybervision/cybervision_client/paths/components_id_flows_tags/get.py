...
SchemaFor200ResponseBodyApplicationJson = DetailedTags
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_component_flow_tag_list_oapg(
        self,
...
class GetComponentFlowTagList(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def get_component_flow_tag_list(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def get_component_flow_tag_list(
        ...
        return self._get_component_flow_tag_list_oapg(
