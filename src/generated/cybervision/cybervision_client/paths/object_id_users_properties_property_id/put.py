...
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        ...
        'propertyId': typing.Union[PropertyIdSchema, str, ],
    }
)
...
request_path_object = api_client.PathParameter(
    name="object",
...
# body param
SchemaForRequestBodyApplicationJson = UpdateExtraFieldBody


request_body_update_extra_field_body = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = SimpleResponse
...
class BaseApi(api_client.Api):
    ...
    def _put_extra_field_oapg(
        ...
        """
        Update extra property to either a component, a group or a device.
        ...
        _fields = None
        _body = None
        serialized_data = request_body_update_extra_field_body.serialize(body, content_type)
...
class PutExtraField(BaseApi):
    ...
    def put_extra_field(
        ...
        return self._put_extra_field_oapg(
            body=body,
