...
SchemaFor200ResponseBodyApplicationJson = PresetSettings
...
class GetPresetSettings(BaseApi):
    ...
    def get_preset_settings(
        ...
        return self._get_preset_settings_oapg(
