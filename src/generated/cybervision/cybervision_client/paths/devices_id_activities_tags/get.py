...
class BaseApi(api_client.Api):
    @typing.overload
    def _list_device_activities_tags_oapg(
        self,
    ...
    def _list_device_activities_tags_oapg(
        ...
        """
        List activities tags of a device for v3 api.
...
class ListDeviceActivitiesTags(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def list_device_activities_tags(
        self,
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def list_device_activities_tags(
        ...
        return self._list_device_activities_tags_oapg(
