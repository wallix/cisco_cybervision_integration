...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['NetworkNodes']:
            return NetworkNodes

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['NetworkNodes'], typing.List['NetworkNodes']],
    ...
    def __getitem__(self, i: int) -> 'NetworkNodes':
...
class GetDeviceList(BaseApi):
    ...
    def get_device_list(
        ...
        return self._get_device_list_oapg(
