...
VulnerabilitiesSchema = schemas.BoolSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'vulnerabilities': typing.Union[VulnerabilitiesSchema, bool, ],
    },
    total=False
)
...
request_query_vulnerabilities = api_client.QueryParameter(
    name="vulnerabilities",
    style=api_client.ParameterStyle.FORM,
    schema=VulnerabilitiesSchema,
    explode=True,
)
_auth = [
    'token',
