...
from cybervision_client.exceptions import (
    ApiTypeError,
    ApiValueError,
)
from cybervision_client.configuration import (
    Configuration,
)
...
if typing.TYPE_CHECKING:
    ...
    # Manually adding NoneClass as valid type for the following classes
    ...
    class BytesMixin:
        _types = {NoneClass, bytes}

    class FileMixin:
        _types = {NoneClass, FileIO}
