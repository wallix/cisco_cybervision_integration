...
class PresetSensorFilter(
    ...
    PresetSensorFilter explicit how
a Sensor will be used as filter
in a Preset
    """
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["value"]) -> 'Sensor': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["value"]) -> typing.Union['Sensor', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        value: typing.Union['Sensor', schemas.Unset] = schemas.unset,
