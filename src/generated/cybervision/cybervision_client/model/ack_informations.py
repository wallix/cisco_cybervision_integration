...
class AckInformations(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["author", "comment", "component", "time", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["author", "comment", "component", "time", ], str]):
