...
class Tag(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["category", "id", "important", "label", "type", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["category", "id", "important", "label", "type", ], str]):
