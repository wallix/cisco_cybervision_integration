...
class Aggregation(
        ...
        class properties:
            ...
            class components(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['AggregatedComponent']:
                        return AggregatedComponent
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['AggregatedComponent'], typing.List['AggregatedComponent']],
                ...
                def __getitem__(self, i: int) -> 'AggregatedComponent':
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["components", "type", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["components", "type", ], str]):
