...
class ShortComponent(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["tags", "customLabel", "group", "icon", "id", "ip", "label", "mac", "originalLabel", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["tags", "customLabel", "group", "icon", "id", "ip", "label", "mac", "originalLabel", ], str]):
