...
class VariableAccessComponent(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["customLabel", "icon", "id", "label", "originalLabel", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["customLabel", "icon", "id", "label", "originalLabel", ], str]):
