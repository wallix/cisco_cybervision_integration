...
class PresetRiskScoreFilter(
    ...
    PresetRiskScoreFilter explicit how
a range between min and max can be
used as filter in a Preset
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def value() -> typing.Type['PresetRiskScore']:
                return PresetRiskScore
            __annotations__ = {
                "operator": operator,
                "value": value,
            }
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["value"]) -> 'PresetRiskScore': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["value"]) -> typing.Union['PresetRiskScore', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        value: typing.Union['PresetRiskScore', schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
        **kwargs: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, None, list, tuple, bytes],
    ) -> 'PresetRiskScoreFilter':
