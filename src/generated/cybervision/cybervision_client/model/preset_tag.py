...
when fetched in a Preset
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["category", "id", "label", "type", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["category", "id", "label", "type", ], str]):
