...
class PresetGroupFilter(
    ...
    PresetGroupFilter explicit how
a Group will be used as filter
in a Preset
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def value() -> typing.Type['PresetGroup']:
                return PresetGroup
            __annotations__ = {
                "operator": operator,
                "value": value,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["value"]) -> 'PresetGroup': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["value"]) -> typing.Union['PresetGroup', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        value: typing.Union['PresetGroup', schemas.Unset] = schemas.unset,
