...
# body param
SchemaForRequestBodyApplicationJson = DevicePut


request_body_device_put = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _edit_device_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_device_put.serialize(body, content_type)
