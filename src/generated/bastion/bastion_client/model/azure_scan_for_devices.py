...
class AzureScanForDevices(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def credential() -> typing.Type['AzureCredential']:
            ...
            class filters(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['AzureFilter']:
                        return AzureFilter
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['AzureFilter'], typing.List['AzureFilter']],
                    _configuration: typing.Optional[schemas.Configuration] = None,
                ) -> 'filters':
                    return super().__new__(
                        cls,
                ...
                def __getitem__(self, i: int) -> 'AzureFilter':
                    return super().__getitem__(i)
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["credential"]) -> 'AzureCredential': ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "name", "description", "emails", "type", "credential", "filters", "protocols", "banner_regex", "scan_for_accounts", "master_accounts", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["credential"]) -> typing.Union['AzureCredential', schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "name", "description", "emails", "type", "credential", "filters", "protocols", "banner_regex", "scan_for_accounts", "master_accounts", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        credential: typing.Union['AzureCredential', schemas.Unset] = schemas.unset,
