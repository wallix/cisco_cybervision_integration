...
class NetworksScanForDevices(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "name", "description", "emails", "type", "subnets", "protocols", "banner_regex", "scan_for_accounts", "master_accounts", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["subnets"]) -> typing.Union[MetaOapg.properties.subnets, schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "name", "description", "emails", "type", "subnets", "protocols", "banner_regex", "scan_for_accounts", "master_accounts", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        subnets: typing.Union[MetaOapg.properties.subnets, list, tuple, schemas.Unset] = schemas.unset,
