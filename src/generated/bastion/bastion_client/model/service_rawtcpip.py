...
class ServiceRawtcpip(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def multi_tunneling() -> typing.Type['ServicePostRawtcpipMultiTunneling']:
                return ServicePostRawtcpipMultiTunneling
            seamless_connection = schemas.BoolSchema
            __annotations__ = {
                ...
                "multi_tunneling": multi_tunneling,
                "seamless_connection": seamless_connection,
            }
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["multi_tunneling"]) -> 'ServicePostRawtcpipMultiTunneling': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["seamless_connection"]) -> MetaOapg.properties.seamless_connection: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["protocol"], typing_extensions.Literal["port"], typing_extensions.Literal["service_name"], typing_extensions.Literal["connection_policy"], typing_extensions.Literal["id"], typing_extensions.Literal["global_domains"], typing_extensions.Literal["multi_tunneling"], typing_extensions.Literal["seamless_connection"], ]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["multi_tunneling"]) -> typing.Union['ServicePostRawtcpipMultiTunneling', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["seamless_connection"]) -> typing.Union[MetaOapg.properties.seamless_connection, schemas.Unset]: ...
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        multi_tunneling: typing.Union['ServicePostRawtcpipMultiTunneling', schemas.Unset] = schemas.unset,
        seamless_connection: typing.Union[MetaOapg.properties.seamless_connection, bool, schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
    ) -> 'ServiceRawtcpip':
        return super().__new__(
            cls,
