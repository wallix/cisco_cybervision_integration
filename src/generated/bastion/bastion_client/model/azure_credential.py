...
class AzureCredential(
    ...
    class MetaOapg:
        ...
        def discriminator():
            return {
                'type': {
                    'azure_certificate_credential': AzureCertificateCredential,
                    'azure_client_secret_credential': AzureClientSecretCredential,
                    'certificate': AzureCertificateCredential,
                    'client_secret': AzureClientSecretCredential,
                }
            }
