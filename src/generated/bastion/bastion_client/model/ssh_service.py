...
class SshService(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "service_name", "protocol", "port", "subprotocols", "connection_policy", "global_domains", "url", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "service_name", "protocol", "port", "subprotocols", "connection_policy", "global_domains", "url", ], str]):
