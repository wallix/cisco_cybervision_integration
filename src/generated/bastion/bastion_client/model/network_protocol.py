...
class NetworkProtocol(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["protocol", "port", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["protocol", "port", ], str]):
